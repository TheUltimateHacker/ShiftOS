Public Class Colour_Picker
    ...
    Private Sub Template_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ShiftOSDesktop.pnlpanelbuttoncolourpicker.SendToBack()
        ShiftOSDesktop.setuppanelbuttons()
        ShiftOSDesktop.setpanelbuttonappearnce(ShiftOSDesktop.pnlpanelbuttoncolourpicker, ShiftOSDesktop.tbcolourpickericon, ShiftOSDesktop.tbcolourpickertext, True)
    ...
    Public Sub setuptitlebar()
        ...
        If justopened = True Then
            Me.Size = New Size(447, 596) 'put the default size of your window here
        ...
        Else
            ...
            lbtitletext.Text = ShiftOSDesktop.colourpickername
            lbtitletext.Show()
        End If
        ...
        If ShiftOSDesktop.boughtcolourpickericon = True Then
