Public Class Web_Browser
    ...
    Private Sub Template_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ShiftOSDesktop.pnlpanelbuttonwebbrowser.SendToBack() 'modfiy to proper name
    ...
    Public Sub setuptitlebar()
        ...
        Else
            ...
            If webwindow.DocumentTitle = "" Then lbtitletext.Text = ShiftOSDesktop.webbrowsername Else lbtitletext.Text = ShiftOSDesktop.webbrowsername & " - " & webwindow.DocumentTitle
            lbtitletext.Show()
        End If
    ...
    Private Sub txtlocation_KeyDown(sender As Object, e As KeyEventArgs) Handles txtlocation.KeyDown
        If e.KeyCode = Keys.Enter Then
            If txtlocation.Text.Contains(".") Then webwindow.Navigate(txtlocation.Text) Else webwindow.Navigate("http://www.google.co.uk/search?q=" & txtlocation.Text)
        End If
    End Sub

    Private Sub webwindow_Navigated(sender As Object, e As WebBrowserNavigatedEventArgs) Handles webwindow.Navigated
        txtlocation.Text = webwindow.Url.ToString
        If webwindow.DocumentTitle = "" Then lbtitletext.Text = ShiftOSDesktop.webbrowsername Else lbtitletext.Text = ShiftOSDesktop.webbrowsername & " - " & webwindow.DocumentTitle
        centretitletext()
    End Sub
    ...
    Private Sub btnback_Click(sender As Object, e As EventArgs) Handles btnback.Click
        If webwindow.CanGoBack = True Then webwindow.GoBack()
    End Sub

    Private Sub btnforward_Click(sender As Object, e As EventArgs) Handles btnforward.Click
        If webwindow.CanGoForward = True Then webwindow.GoForward()
    End Sub

    Private Sub gohome()
        webwindow.Navigate(ShiftOSDesktop.webbrowserhomepage)
        centretitletext()
    End Sub
