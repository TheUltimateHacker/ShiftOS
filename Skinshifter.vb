Public Class Skinshifter
    ...
    Private Sub Template_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ShiftOSDesktop.pnlpanelbuttonskinshifter.SendToBack() 'modfiy to proper name
    ...
    Public Sub setuptitlebar()
        ...
        If justopened = True Then
            Me.Size = New Size(455, 229) 'put the default size of your window here
    ...
    Private Sub lbskinlist_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lbskinlist.SelectedIndexChanged
        If moveitemignore = False Then
            ...
            Else
                ...
                System.IO.Compression.ZipFile.ExtractToDirectory(lbskinlist.SelectedItem.ToString, "C:\ShiftOS\Shiftum42\Skins\Preview\")
