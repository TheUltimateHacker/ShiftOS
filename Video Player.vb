Public Class Video_Player
    ...
    Private Sub Template_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ShiftOSDesktop.pnlpanelbuttonvideoplayer.SendToBack() 'modfiy to proper name
    ...
    Public Sub setuptitlebar()
        ...
        If justopened = True Then
            Me.Size = New Size(750, 480) 'put the default size of your window here
        ...
        Else
            ...
            lbtitletext.Text = ShiftOSDesktop.videoplayername
            lbtitletext.Show()
        End If
