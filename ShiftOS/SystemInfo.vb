Public Class systeminfo
    ...
    Public minimumsizewidth As Integer = 458   'replace with minimum size
    Public minimumsizeheight As Integer = 265  'replace with minimum size
...
#Region "Template Code"
    ...
    Private Sub Template_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        setupall()
        If ShiftOSDesktop.SystemInfoCorrupted Then Me.Close() : infobox.showinfo("The Plague.", Me.Name & "has been corrupted by The Plague.")

        ShiftOSDesktop.pnlpanelbuttonsysinfo.SendToBack() 'CHANGE NAME
        ShiftOSDesktop.setuppanelbuttons()
        ShiftOSDesktop.setpanelbuttonappearnce(ShiftOSDesktop.pnlpanelbuttonsysinfo, ShiftOSDesktop.tbsysinfoicon, ShiftOSDesktop.tbsysinfotext, True) 'modify to proper name
        ShiftOSDesktop.programsopen = ShiftOSDesktop.programsopen + 1

        'CODE HERE
        SysInfoBox1.Text = ShiftOSDesktop.ingameversion
        SysInfoBox2.Text = ShiftOSDesktop.username
        SysInfoTextBox5.Text = ShiftOSDesktop.osname
    ...
    Public Sub setuptitlebar()
        ...
        If justopened = True Then
            Me.Size = New Size(442, 250) 'put the default size of your window here
        ...
        Else
            ...
            lbtitletext.Text = ShiftOSDesktop.sysinfoname 'Remember to change to name of program!!!!
            lbtitletext.Show()
        End If
        ...
        If ShiftOSDesktop.boughtsysinfoicon = True Then ' Change to program's icon
            pnlicon.Visible = True
            pnlicon.Location = New Point(Skins.titleiconfromside, Skins.titleiconfromtop)
            pnlicon.Size = New Size(ShiftOSDesktop.titlebariconsize, ShiftOSDesktop.titlebariconsize)
            pnlicon.Image = ShiftOSDesktop.sysinfoicontitlebar  'Replace with the correct icon for the program.
        End If
