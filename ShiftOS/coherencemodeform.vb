...
#Region "Template Code"
    ...
    Public programnametokeep As Window
    Public RollUpAndDownHW As System.Drawing.Size
...
#End Region
    ...
    Private Sub titlebar_MouseMove(sender As Object, e As MouseEventArgs) Handles titlebar.MouseMove
        If MouseDown = True Then
            ...
            programnametokeep.Location = New Point(tmpPoint.X, tmpPoint.Y + ShiftOSDesktop.titlebarheight)
        End If
    End Sub
    ...
    Private Sub forcetitle_Tick(sender As Object, e As EventArgs) Handles forcetitle.Tick
        If Me.Focused = False And programnametokeep.Focused = False Then
            Try
                programnametokeep.Text = lbtitletext.Text
            Catch ex As Exception
                infobox.Show()
                infobox.lbtitletext.Text = "Error - Coherence Mode"
                infobox.lblintructtext.Text = "Lost focus on application, make sure you type in the program name instead of a variable."
                Me.Close()
            End Try
        End If
    End Sub
