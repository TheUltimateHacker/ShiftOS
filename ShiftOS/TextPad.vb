...
#Region "Template Code"
    ...
    Private Sub Template_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        setupall()
        If ShiftOSDesktop.TextpadCorrupted Then Me.Close() : infobox.showinfo("The Plague.", Me.Name & "has been corrupted by The Plague.")

        ShiftOSDesktop.pnlpanelbuttontextpad.SendToBack() 'CHANGE NAME
        ShiftOSDesktop.setuppanelbuttons()
        ShiftOSDesktop.setpanelbuttonappearnce(ShiftOSDesktop.pnlpanelbuttontextpad, ShiftOSDesktop.tbtextpadicon, ShiftOSDesktop.tbtextpadtext, True) 'modify to proper name
    ...
    Public Sub setuptitlebar()
        ...
        Else
            ...
            lbtitletext.Text = ShiftOSDesktop.textpadname 'Remember to change to name of program!!!!
            lbtitletext.Show()
        End If
        ...
        If ShiftOSDesktop.boughttextpadicon = True Then ' Change to program's icon
...
#End Region
    ...
    Public Sub showsavedialog()
        If ShiftOSDesktop.boughttextpadtrm = True Then
            File_Saver.useformatchooser = True
            File_Saver.nondefaultextention(0) = ".trm"
        End If
        File_Saver.Show()
