Public Class Video_Player
    ...
    Public minimumsizewidth As Integer = 251
    Public minimumsizeheight As Integer = 125
...
#Region "Template Code"
    ...
    Private Sub Template_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        setupall()
        If ShiftOSDesktop.VideoPlayerCorrupted Then Me.Close() : infobox.showinfo("The Plague.", Me.Name & "has been corrupted by The Plague.")

        ShiftOSDesktop.pnlpanelbuttonvideoplayer.SendToBack() 'CHANGE NAME
        ShiftOSDesktop.setuppanelbuttons()
        ShiftOSDesktop.setpanelbuttonappearnce(ShiftOSDesktop.pnlpanelbuttonvideoplayer, ShiftOSDesktop.tbvideoplayericon, ShiftOSDesktop.tbvideoplayertext, True) 'modify to proper name
    ...
    Public Sub setuptitlebar()
        ...
        Else
            ...
            lbtitletext.Text = ShiftOSDesktop.videoplayername 'Remember to change to name of program!!!!
            lbtitletext.Show()
        End If
        ...
        If ShiftOSDesktop.boughtshiftneticon = True Then ' Change to program's icon
            ...
            pnlicon.Image = ShiftOSDesktop.videoplayericontitlebar  'Replace with the correct icon for the program.
        End If
...
#End Region
    ...
    Private Sub btnplay_Click(sender As Object, e As EventArgs) Handles btnplay.Click
        ...
        Else
            If AxWindowsMediaPlayer1.playState = WMPLib.WMPPlayState.wmppsPlaying Then
                ...
                btnplay.BackgroundImage = My.Resources.playbutton
            Else
                AxWindowsMediaPlayer1.Ctlcontrols.play()
                btnplay.BackgroundImage = My.Resources.pausebutton
            End If
        End If
    End Sub
    ...
    Private Sub btnload_Click(sender As Object, e As EventArgs) Handles btnload.Click
        File_Opener.Show()
        File_Opener.openingprogram = "videoplayer"
        File_Opener.openextention = ".mp4"
    ...
    Private Sub trackjumpto(ByVal e As MouseEventArgs)
