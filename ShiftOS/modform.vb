...
#End Region
    ...
    Public Sub CreateLabel(ByVal LabelName As String)
        Try
    ...
    Public Sub SelectLabel(ByVal LabelName As String)
        Try
    ...
    Public Sub MoveSelectedLabelLocationX(ByVal XLocation As Integer)
        Try
            SelectedLabel.Location = New Point(XLocation, SelectedLabel.Location.Y)
        Catch ex As Exception
            infobox.showinfo("Critical Modification Application Error", "A critical error occured whilst trying to add to your codepoint value - please contact the developer of your mod")
        End Try
    End Sub

    Public Sub MoveSelectedLabelLocationY(ByVal YLocation As Integer)
        Try
            SelectedLabel.Location = New Point(SelectedLabel.Location.X, YLocation)
        Catch ex As Exception
            infobox.showinfo("Critical Modification Application Error", "A critical error occured whilst trying to add to your codepoint value - please contact the developer of your mod")
        End Try
    End Sub

    Public Sub SelectedLabelText(ByVal LabelText As String)
        Try
